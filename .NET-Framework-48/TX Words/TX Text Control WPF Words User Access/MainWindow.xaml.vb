...
Namespace TXTextControl.Words
    ...
    Partial Public Class MainWindow
        ...
        Private Sub SetAppMenuDesign()
            ...
            Me.SetMenuItemDesign(ResourceProvider.FileMenuItem.TXITEM_SignIn.ToString(), Me.m_rmiSignIn, m_strUserName)
            Me.SetMenuItemDesign(ResourceProvider.FileMenuItem.TXITEM_CurrentUser.ToString(), Me.m_rmbtnCurrentUser, m_strUserName)
            Me.SetMenuItemDesign(ResourceProvider.FileMenuItem.TXITEM_AccountSettings.ToString(), Me.m_rmiAccountSettings, m_strUserName)
            Me.SetMenuItemDesign(ResourceProvider.FileMenuItem.TXITEM_SignOut.ToString(), Me.m_rmiSignOut, m_strUserName)
        ...
        Private Sub SetAppMenuBehavior()
            ...
            ' Sign In:
            AddHandler Me.m_rmiSignIn.Click, AddressOf Me.SignIn_Click

            ' [Current User]:
            AddHandler Me.m_rmiAccountSettings.Click, AddressOf Me.AccountSettings_Click ' Account Settings (Drop Down Button)
            AddHandler Me.m_rmiSignOut.Click, AddressOf Me.SignOut_Click ' Sign Out (Drop Down Button)
        End Sub
        ...
        ' Load the sample document and sets the focus to the document.
        ' *-----------------------------------------------------------------------------------------------------
        Private Sub TextControl_Loaded_MainWindow(ByVal sender As Object, ByVal e As RoutedEventArgs)
            Me.Open(m_strFilesDirectory & "Protected Document.tx", StreamType.InternalUnicodeFormat)
