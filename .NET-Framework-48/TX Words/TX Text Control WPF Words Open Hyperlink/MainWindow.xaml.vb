    ...
    Partial Public Class MainWindow
        ...
        Public Sub New()
            ...
            If rstrArgs.Length <= 1 Then
                AddHandler Me.m_txTextControl.Loaded, AddressOf Me.TextControl_Loaded_Sample
            End If
        End Sub
        ...
        '-----------------------------------------------------------------------------------------------------------
        Private Sub TextControl_Loaded_Sample(ByVal sender As Object, ByVal e As RoutedEventArgs)
            Me.Open(m_strFilesDirectory & "Hyperlink Document.tx", StreamType.InternalUnicodeFormat)
