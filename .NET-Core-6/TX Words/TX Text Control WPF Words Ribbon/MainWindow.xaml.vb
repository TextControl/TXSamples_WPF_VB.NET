...
Namespace TXTextControl.Words
    ...
    Partial Public Class MainWindow
        ...
        Private Sub SetAppMenuDesign()
            ...
            Me.SetMenuItemDesign(ResourceProvider.FileMenuItem.TXITEM_DocumentSettings.ToString(), Me.m_rtbtnDocumentSettings)
            ...
            Me.SetMenuItemDesign(ResourceProvider.FileMenuItem.TXITEM_Exit.ToString(), Me.m_rmiExit)
        ...
        Private Sub SetAppMenuBehavior()
            ...
            ' Exit:
            AddHandler Me.m_rmiExit.Click, AddressOf Me.Exit_Click
        End Sub
