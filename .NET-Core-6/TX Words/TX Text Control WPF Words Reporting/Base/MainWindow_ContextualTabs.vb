...
Namespace TXTextControl.Words
    Partial Class MainWindow
        ...
        Private Sub TextControl_InputPositionChanged(ByVal sender As Object, ByVal e As EventArgs)
            Me.m_ctgTableTools.Visibility = If(Me.m_txTextControl.Tables.GetItem() IsNot Nothing AndAlso Me.m_ctgReportingResult.Visibility <> Windows.Visibility.Visible, Windows.Visibility.Visible, Windows.Visibility.Collapsed)
        End Sub
        ...
        Private Sub TextControl_FrameSelected(ByVal sender As Object, ByVal e As FrameEventArgs)
            ...
            Me.m_ctgFrameTools.Visibility = If(Me.m_ctgReportingResult.Visibility <> Windows.Visibility.Visible, Windows.Visibility.Visible, Windows.Visibility.Collapsed)
        End Sub
